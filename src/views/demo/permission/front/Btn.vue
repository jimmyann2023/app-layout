  ...
  >
    ...
    <div class="mt-4">
      ...
      <Space>
        ...
        <a-button @click="changeRole(RoleEnum.DEV)" :type="isDev ? 'primary' : 'default'">
          {{ RoleEnum.DEV }}
        </a-button>
    ...
    <Authority :value="RoleEnum.DEV">
      <a-button color="success" class="mx-4"> 拥有 developer 角色权限可见 </a-button>
    </Authority>
    ...
    <Authority :value="[RoleEnum.TEST, RoleEnum.DEV, RoleEnum.SUPER]">
      <a-button color="error" class="mx-4"> 拥有[test,develop ,super]角色权限可见 </a-button>
    </Authority>
    ...
    <a-button v-if="hasPermission(RoleEnum.DEV)" type="primary" class="mx-4">
      拥有develop 角色权限可见
    </a-button>
    ...
    <a-button
      v-if="hasPermission([RoleEnum.TEST, RoleEnum.DEV, RoleEnum.SUPER])"
      color="error"
      class="mx-4"
    >
      拥有[test,develop,super]角色权限可见
    </a-button>

    <Divider>指令方式方式判断权限(该方式不能动态修改权限.)</Divider>
    <a-button v-auth="RoleEnum.SUPER" type="primary" class="mx-4"> 拥有super角色权限可见 </a-button>

    <a-button v-auth="RoleEnum.DEV" type="primary" class="mx-4">
      拥有developer 角色权限可见
    </a-button>

    <a-button v-auth="RoleEnum.TEST" color="success" class="mx-4"> 拥有test角色权限可见 </a-button>

    <a-button v-auth="[RoleEnum.TEST, RoleEnum.DEV, RoleEnum.SUPER]" color="error" class="mx-4">
      拥有[test,develop,super]角色权限可见
    </a-button>
  </PageWrapper>
</template>
